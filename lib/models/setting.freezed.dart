...
abstract class $SettingCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeMode theme, bool subscription});
}
...
class _$_Setting extends _Setting {
  const _$_Setting({this.theme = ThemeMode.light, this.subscription = false})
      : super._();
  ...
  @override
  String toString() {
    return 'Setting(theme: $theme, subscription: $subscription)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, theme, subscription);
...
abstract class _Setting extends Setting {
  const factory _Setting({final ThemeMode theme, final bool subscription}) =
      _$_Setting;
