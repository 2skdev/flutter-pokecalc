...
///
/// 親ウィジェット(InputStatsWidget)のKeyboardActionsItemで参照するため
/// [node]と[controller]をpublicにする
class StatsTextFieldWidget extends HookWidget {
  StatsTextFieldWidget({
    super.key,
    required this.value,
    this.min,
    this.max,
...
class InputStatsWidget extends HookWidget {
  const InputStatsWidget({
    super.key,
