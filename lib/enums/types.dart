...
enum Types implements StringNamedEnum {
  ...
  electric(string: 'でんき', color: Color(0xFFEDC931)),
  grass(string: 'くさ', color: Color(0xFF6EB54B)),
  ...
  bug(string: 'むし', color: Color(0xFFABB03B)),
  rock(string: 'いわ', color: Color(0xFFBFB88E)),
